        ...
        <div class="login-box">
            ...
            <form action="${PATH }/saveUser" method="post" class="regist_form">
                ...
                <div class="login-btn">
                    ...
                    <a type="submit" class="bt" onclick="regist()">注册</a>
                </div>
                <div class="resigter">
        ...
        $('#code-btn').click(function(){
            ...
            var timer = setInterval(function(){  
              ...
              if (count==0) {
                ...
                $("#code-btn").html("重新发送验证码").style("color","red");
...
//	     				alert(typeof(msg));
	          		...
	          		var reuserpswd = /^.*(?=.{8,16}).*$/;
	    			 if(reuserpswd.test(userpswd)==false){
	    				 layer.alert("请输入8-16位密码",{icon:99});
	    	    		  return false;
	    			 }else{
	    				 if(userpswd != rePswd){
